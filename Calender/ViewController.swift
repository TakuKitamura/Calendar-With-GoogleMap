        ...
        case 1:
            ...
            if(cell.textLabel?.text != ""){
                ...
                case "1" :
                    ...
                    dateButton1.addTarget(self, action: #selector(changeColor(sender: )), for: .touchUpInside)
                ...
                case "2" :
                    ...
                    dateButton2.addTarget(self, action: #selector(changeColor(sender: )), for: .touchUpInside)
                ...
                case "3" :
                    ...
                    dateButton3.addTarget(self, action: #selector(changeColor(sender: )), for: .touchUpInside)
                ...
                case "4" :
                    ...
                    dateButton4.addTarget(self, action: #selector(changeColor(sender: )), for: .touchUpInside)
                ...
                case "5" :
                    ...
                    dateButton5.addTarget(self, action: #selector(changeColor(sender: )), for: .touchUpInside)
                ...
                case "6" :
                    ...
                    dateButton6.addTarget(self, action: #selector(changeColor(sender: )), for: .touchUpInside)
                ...
                case "7" :
                    ...
                    dateButton7.addTarget(self, action: #selector(changeColor(sender: )), for: .touchUpInside)
                ...
                case "8" :
                    ...
                    dateButton8.addTarget(self, action: #selector(changeColor(sender: )), for: .touchUpInside)
                ...
                case "9" :
                    ...
                    dateButton9.addTarget(self, action: #selector(changeColor(sender: )), for: .touchUpInside)
                ...
                case "10" :
                    ...
                    dateButton10.addTarget(self, action: #selector(changeColor(sender: )), for: .touchUpInside)
                ...
                case "11" :
                    ...
                    dateButton11.addTarget(self, action: #selector(changeColor(sender: )), for: .touchUpInside)
                ...
                case "12" :
                    ...
                    dateButton12.addTarget(self, action: #selector(changeColor(sender: )), for: .touchUpInside)
                ...
                case "13" :
                    ...
                    dateButton13.addTarget(self, action: #selector(changeColor(sender: )), for: .touchUpInside)
                ...
                case "14" :
                    ...
                    dateButton14.addTarget(self, action: #selector(changeColor(sender: )), for: .touchUpInside)
                ...
                case "15" :
                    ...
                    dateButton15.addTarget(self, action: #selector(changeColor(sender: )), for: .touchUpInside)
                ...
                case "16" :
                    ...
                    dateButton16.addTarget(self, action: #selector(changeColor(sender: )), for: .touchUpInside)
                ...
                case "17" :
                    ...
                    dateButton17.addTarget(self, action: #selector(changeColor(sender: )), for: .touchUpInside)
                ...
                case "18" :
                    ...
                    dateButton18.addTarget(self, action: #selector(changeColor(sender: )), for: .touchUpInside)
                ...
                case "19" :
                    ...
                    dateButton19.addTarget(self, action: #selector(changeColor(sender: )), for: .touchUpInside)
                ...
                case "20" :
                    ...
                    dateButton20.addTarget(self, action: #selector(changeColor(sender: )), for: .touchUpInside)
                ...
                case "21" :
                    ...
                    dateButton21.addTarget(self, action: #selector(changeColor(sender: )), for: .touchUpInside)
                ...
                case "22" :
                    ...
                    dateButton22.addTarget(self, action: #selector(changeColor(sender: )), for: .touchUpInside)
                ...
                case "23" :
                    ...
                    dateButton23.addTarget(self, action: #selector(changeColor(sender: )), for: .touchUpInside)
                ...
                case "24" :
                    ...
                    dateButton24.addTarget(self, action: #selector(changeColor(sender: )), for: .touchUpInside)
                ...
                case "25" :
                    ...
                    dateButton25.addTarget(self, action: #selector(changeColor(sender: )), for: .touchUpInside)
                ...
                case "26" :
                    ...
                    dateButton26.addTarget(self, action: #selector(changeColor(sender: )), for: .touchUpInside)
                ...
                case "27" :
                    ...
                    dateButton27.addTarget(self, action: #selector(changeColor(sender: )), for: .touchUpInside)
                ...
                case "28" :
                    ...
                    dateButton28.addTarget(self, action: #selector(changeColor(sender: )), for: .touchUpInside)
                ...
                case "29" :
                    ...
                    dateButton29.addTarget(self, action: #selector(changeColor(sender: )), for: .touchUpInside)
                ...
                case "30" :
                    ...
                    dateButton30.addTarget(self, action: #selector(changeColor(sender: )), for: .touchUpInside)
                ...
                case "31" :
                    ...
                    dateButton31.addTarget(self, action: #selector(changeColor(sender: )), for: .touchUpInside)
